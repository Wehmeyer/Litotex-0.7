...
while($row=$db->fetch_array($result)) {
	...
	$tt="onmouseover=\"Tip('Landname:$land_name<br>Besitzer:$cur_name<br>Gr��e:$land_size<br>Bebaut:$land_cursize',TITLE,'Info ',FADEIN,400,SHADOW, true,OPACITY, 100,BGCOLOR,'#D3E3F6',BORDERWIDTH,'0',PADDING, 0)\" onmouseout=\"UnTip()\"";
	if ($row['picid']==1) {
...
while($row=$db->fetch_array($result)) {
	...
	$land_size=$row['size'];
	$land_cursize=$row['usesize'];
	$tt="onmouseover=\"Tip('Landname:$land_name<br>Besitzer:$cur_name<br>Gr��e:$land_size<br>Bebaut:$land_cursize',TITLE,'Info ',BGCOLOR,'#D3E3F6',BORDERWIDTH,'0',FADEIN,400,SHADOW, true,OPACITY, 100,PADDING, 0)\" onmouseout=\"UnTip()\"";
